...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-black text-white tracking-tight">Nueva <span class="text-teal-400">Factura</span></h1>
            <p class="text-slate-400 text-sm mt-1 font-medium">Registra un nuevo cobro o pago en el sistema</p>
        </div>
    </div>

    {{-- FORMULARIO --}}
    <form action="{{ route('facturas.store') }}" method="POST" class="bg-slate-800/50 border border-slate-700 shadow-2xl rounded-2xl p-6 sm:p-8 space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="total" required placeholder="0"
       ...
       oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            ...
            <div>
                <label class="block mb-2 font-bold text-sm text-slate-300">Descripción del Servicio</label>
                <textarea name="descripcion" rows="4" required
                          ...
                          placeholder="Detalla los servicios odontológicos prestados..."></textarea>
            </div>
